...
#ifndef UNIT_CONVERTER_SWIFT_H
#define UNIT_CONVERTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="unit_converter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14unit_converter11AppDelegate")
...
SWIFT_CLASS("_TtC14unit_converter17MainFlutterWindow")
